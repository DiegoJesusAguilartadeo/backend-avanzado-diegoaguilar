    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-products--product_id-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-cart">Obtener el carrito del usuario.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-cart">
                                <a href="#endpoints-POSTapi-cart">Agregar producto al carrito.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-cart--itemId-">
                                <a href="#endpoints-DELETEapi-cart--itemId-">Eliminar ítem del carrito</a>
                            </li>
                    ...
                    <ul id="tocify-header-gestion-de-categorias" class="tocify-header">
                <li class="tocify-item level-1" data-unique="gestion-de-categorias">
                    <a href="#gestion-de-categorias">Gestión de Categorías</a>
                </li>
                                    <ul id="tocify-subheader-gestion-de-categorias" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="gestion-de-categorias-GETapi-categories">
                                <a href="#gestion-de-categorias-GETapi-categories">Listar Categorías</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-categorias-GETapi-categories--category_id-">
                                <a href="#gestion-de-categorias-GETapi-categories--category_id-">Mostrar Categoría</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-categorias-POSTapi-categories">
                                <a href="#gestion-de-categorias-POSTapi-categories">Crear Categoría</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-categorias-PUTapi-categories--category_id-">
                                <a href="#gestion-de-categorias-PUTapi-categories--category_id-">Actualizar Categoría</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-categorias-DELETEapi-categories--category_id-">
                                <a href="#gestion-de-categorias-DELETEapi-categories--category_id-">Eliminar Categoría</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-gestion-de-ordenes" class="tocify-header">
                <li class="tocify-item level-1" data-unique="gestion-de-ordenes">
                    <a href="#gestion-de-ordenes">Gestión de Órdenes</a>
                </li>
                                    <ul id="tocify-subheader-gestion-de-ordenes" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="gestion-de-ordenes-GETapi-orders">
                                <a href="#gestion-de-ordenes-GETapi-orders">Listar órdenes del usuario autenticado</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-ordenes-POSTapi-orders">
                                <a href="#gestion-de-ordenes-POSTapi-orders">Crear Orden desde el Carrito y Generar Sesión en Stripe</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-ordenes-GETapi-orders--order_id-">
                                <a href="#gestion-de-ordenes-GETapi-orders--order_id-">Ver Detalle de Orden</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="gestion-de-ordenes-DELETEapi-orders--order_id-">
                                <a href="#gestion-de-ordenes-DELETEapi-orders--order_id-">Eliminar Orden (Solo Administrador)</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-pasarela-de-pago-stripe" class="tocify-header">
                <li class="tocify-item level-1" data-unique="pasarela-de-pago-stripe">
                    <a href="#pasarela-de-pago-stripe">Pasarela de Pago Stripe</a>
                </li>
                                    <ul id="tocify-subheader-pasarela-de-pago-stripe" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="pasarela-de-pago-stripe-GETapi-checkout-success">
                                <a href="#pasarela-de-pago-stripe-GETapi-checkout-success">GET api/checkout/success</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pasarela-de-pago-stripe-GETapi-checkout-cancel">
                                <a href="#pasarela-de-pago-stripe-GETapi-checkout-cancel">GET api/checkout/cancel</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pasarela-de-pago-stripe-POSTapi-stripe-webhook">
                                <a href="#pasarela-de-pago-stripe-POSTapi-stripe-webhook">Procesar Webhook de Stripe</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="pasarela-de-pago-stripe-POSTapi-stripe-checkout">
                                <a href="#pasarela-de-pago-stripe-POSTapi-stripe-checkout">Re-generar Sesión de Checkout para la última orden pendiente del usuario</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;nombre&quot;: &quot;Teclado Mec&aacute;nico RGB&quot;,
            &quot;precio&quot;: 79.99,
            &quot;existencia&quot;: 983,
            &quot;promocionado&quot;: 1,
            &quot;categoria&quot;: &quot;Electr&oacute;nica y C&oacute;mputo&quot;
        },
        {
            &quot;id&quot;: 2,
            &quot;nombre&quot;: &quot;Mouse Gamer Inal&aacute;mbrico&quot;,
            &quot;precio&quot;: 49.99,
            &quot;existencia&quot;: 999,
            &quot;promocionado&quot;: 0,
            &quot;categoria&quot;: &quot;Electr&oacute;nica y C&oacute;mputo&quot;
        ...
        {
            &quot;id&quot;: 5,
            &quot;nombre&quot;: &quot;Silla Ergon&oacute;mica Gamer&quot;,
            &quot;precio&quot;: 219.99,
            &quot;existencia&quot;: 999,
            &quot;promocionado&quot;: 1,
            &quot;categoria&quot;: &quot;Electr&oacute;nica y C&oacute;mputo&quot;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--product_id-">Display the specified resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-cart">Obtener el carrito del usuario.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-cart">Agregar producto al carrito.</h2>
...
<p>Must be at least 1. Example: <code>22</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-cart--itemId-">Eliminar ítem del carrito</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Remueve un producto específico del carrito de compras del usuario autenticado.</p>
...
<div class="bash-example">
    ...
    "http://127.0.0.1:8000/api/cart/architecto" \
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-cart--itemId-"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="itemId"                data-endpoint="DELETEapi-cart--itemId-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>The ID of the product. Example: <code>1</code></p>
                ...
                <h1 id="gestion-de-categorias">Gestión de Categorías</h1>

    <p>Endpoints para la consulta pública y administración de categorías de productos.</p>

                                <h2 id="gestion-de-categorias-GETapi-categories">Listar Categorías</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;Electr&oacute;nica y C&oacute;mputo&quot;,
            &quot;created_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-09-13T21:07:37.000000Z&quot;,
            &quot;products_count&quot;: 6
        },
        {
            &quot;id&quot;: 2,
            &quot;name&quot;: &quot;Monitores&quot;,
            &quot;created_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
            &quot;products_count&quot;: 0
        },
        {
            &quot;id&quot;: 3,
            &quot;name&quot;: &quot;Sillas y Accesorios&quot;,
            &quot;created_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
            &quot;products_count&quot;: 0
        },
        {
            &quot;id&quot;: 4,
            &quot;name&quot;: &quot;Audifonos&quot;,
            &quot;created_at&quot;: &quot;2026-09-13T20:57:49.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2026-09-13T20:57:49.000000Z&quot;,
            &quot;products_count&quot;: 0
        }
    ]
}</code>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="gestion-de-categorias-GETapi-categories--category_id-">Mostrar Categoría</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;products&quot;: [
            {
                &quot;id&quot;: 1,
                &quot;name&quot;: &quot;Teclado Mec&aacute;nico RGB&quot;,
                &quot;price&quot;: 79.99,
                &quot;stock&quot;: 983,
                &quot;is_featured&quot;: 1,
                &quot;category_id&quot;: 1,
                &quot;created_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2026-09-14T03:17:24.000000Z&quot;
            },
            {
                &quot;id&quot;: 2,
                &quot;name&quot;: &quot;Mouse Gamer Inal&aacute;mbrico&quot;,
                &quot;price&quot;: 49.99,
                &quot;stock&quot;: 999,
                &quot;is_featured&quot;: 0,
                &quot;category_id&quot;: 1,
                &quot;created_at&quot;: &quot;2026-09-13T13:45:58.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2026-09-14T02:45:20.000000Z&quot;
            },
            {
                &quot;id&quot;: 3,
            ...
            {
                &quot;id&quot;: 5,
                &quot;name&quot;: &quot;Silla Ergon&oacute;mica Gamer&quot;,
                &quot;price&quot;: 219.99,
                &quot;stock&quot;: 999,
                &quot;is_featured&quot;: 1,
                &quot;category_id&quot;: 1,
            ...
            },
            {
                ...
                &quot;is_featured&quot;: 0,
                &quot;category_id&quot;: 1,
                &quot;created_at&quot;: &quot;2026-09-13T21:41:35.000000Z&quot;,
                &quot;updated_at&quot;: &quot;2026-09-14T02:45:20.000000Z&quot;
            }
        ]
    }
...
<p>The ID of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="gestion-de-categorias-POSTapi-categories">Crear Categoría</h2>
...
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
                    ...
                    <h2 id="gestion-de-categorias-PUTapi-categories--category_id-">Actualizar Categoría</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-categories--category_id-"
               value="Bearer {ACCESS_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {ACCESS_TOKEN}</code></p>
...
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
                    ...
                    <h2 id="gestion-de-categorias-DELETEapi-categories--category_id-">Eliminar Categoría</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-categories--category_id-"
               value="Bearer {ACCESS_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {ACCESS_TOKEN}</code></p>
...
<p>The ID of the category. Example: <code>1</code></p>
                ...
                <h1 id="gestion-de-ordenes">Gestión de Órdenes</h1>

    

                                <h2 id="gestion-de-ordenes-GETapi-orders">Listar órdenes del usuario autenticado</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="gestion-de-ordenes-POSTapi-orders">Crear Orden desde el Carrito y Generar Sesión en Stripe</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="gestion-de-ordenes-GETapi-orders--order_id-">Ver Detalle de Orden</h2>
...
<p>The ID of the order. Example: <code>1</code></p>
                    ...
                    <h2 id="gestion-de-ordenes-DELETEapi-orders--order_id-">Eliminar Orden (Solo Administrador)</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-orders--order_id-"
               value="Bearer {ACCESS_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {ACCESS_TOKEN}</code></p>
...
<p>The ID of the order. Example: <code>1</code></p>
                ...
                <h1 id="pasarela-de-pago-stripe">Pasarela de Pago Stripe</h1>

    <p>Endpoints para el procesamiento de eventos asíncronos y webhooks enviados por Stripe.</p>

                                <h2 id="pasarela-de-pago-stripe-GETapi-checkout-success">GET api/checkout/success</h2>
...
<span id="example-requests-GETapi-checkout-success">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/checkout/success" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/checkout/success"
);
...
<span id="example-responses-GETapi-checkout-success">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Pago procesado o en verificaci&oacute;n.&quot;,
    &quot;session_id&quot;: null
}</code>
 </pre>
    </span>
<span id="execution-results-GETapi-checkout-success" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-checkout-success"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-checkout-success"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-checkout-success" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-checkout-success">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-checkout-success" data-method="GET"
      data-path="api/checkout/success"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-checkout-success', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-checkout-success"
                    onclick="tryItOut('GETapi-checkout-success');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-checkout-success"
                    onclick="cancelTryOut('GETapi-checkout-success');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-checkout-success"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/checkout/success</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-checkout-success"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-checkout-success"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="pasarela-de-pago-stripe-GETapi-checkout-cancel">GET api/checkout/cancel</h2>
...
<span id="example-requests-GETapi-checkout-cancel">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/checkout/cancel" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/checkout/cancel"
);
...
<span id="example-responses-GETapi-checkout-cancel">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-checkout-cancel" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-checkout-cancel"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-checkout-cancel"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-checkout-cancel" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-checkout-cancel">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-checkout-cancel" data-method="GET"
      data-path="api/checkout/cancel"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-checkout-cancel', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-checkout-cancel"
                    onclick="tryItOut('GETapi-checkout-cancel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-checkout-cancel"
                    onclick="cancelTryOut('GETapi-checkout-cancel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-checkout-cancel"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/checkout/cancel</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-checkout-cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-checkout-cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="pasarela-de-pago-stripe-POSTapi-stripe-webhook">Procesar Webhook de Stripe</h2>

<p>
</p>

<p>Recibe y verifica las notificaciones de eventos desde Stripe.
Al recibir un evento 'checkout.session.completed', actualiza la orden a 'paid',
el pago a 'completed' y descuenta el stock de productos en una transacción atómica.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="pasarela-de-pago-stripe-POSTapi-stripe-checkout">Re-generar Sesión de Checkout para la última orden pendiente del usuario</h2>
...
<span id="example-requests-POSTapi-stripe-checkout">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-stripe-checkout">
</span>
<span id="execution-results-POSTapi-stripe-checkout" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-stripe-checkout"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-stripe-checkout"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-stripe-checkout" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-stripe-checkout">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-stripe-checkout" data-method="POST"
      data-path="api/stripe/checkout"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-stripe-checkout', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-stripe-checkout"
                    onclick="tryItOut('POSTapi-stripe-checkout');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-stripe-checkout"
                    onclick="cancelTryOut('POSTapi-stripe-checkout');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-stripe-checkout"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/stripe/checkout</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-stripe-checkout"
               value="Bearer {ACCESS_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {ACCESS_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-stripe-checkout"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-stripe-checkout"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
